...
$userid=$row['userid'];
mysqli_query($conn,"UPDATE `user_pswd` SET `username`='".$pass1."', `create_date`='".$curDate."' WHERE `userid`='".$userid."';");
...
<h2><a href=" login.html" style="text-size:20px;color:red">Click here</a> to Login.</h2><br />';
		}
session_destroy();
?>
</html>
