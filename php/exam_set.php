...
$sql1 = "INSERT INTO Exam_scheduler (id,user_id,Date,Duration,Categoty_id,Level,NoQues,Examinator) VALUES (NULL,'$userid','$date','$duration','$category_id','$level','$noques','$examinator')";
