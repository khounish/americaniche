...
$sql1 = "INSERT INTO Exam_scheduler (id,userid,Date,Start_time,Duration,Subject,Level,Examinator) VALUES ('','$user_id','$date','$time','$duration','$subject','$level','$examinator')";
