...
<body>
  ...
  if (isset($_GET["key"]) && isset($_GET["email"])&& isset($_GET["action"]) && ($_GET["action"]=="reset")  && !isset($_POST["action"]))
  {
    ...
    if ($row=="")
    {
      ...
      <p><a href="http://www.americaniche.com/index.php">Click here</a> to reset password.</p>';
    }
  else
  {
   ...
   /* else
    ...
    <p>The link is expired. You are trying to use the expired link which as valid only 24 hours (1 days after request).<br /><br /></p><p><a href="http://www.americaniche.com/index.php">Click here</a> to reset password.</p>';
