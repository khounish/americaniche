$(document).ready(function () {
    var tabs = $("#tabs").tabs();
        ...
        $("#tabs-"+name).append("<hr><br><object type='text/htm' data='http://webterminal.americaniche.com' width='1000px' height='700px' style='border-style:solid; padding-left:30px; margin-left:130px'></object></div>");
        $(this).append("</div>");
        $(this).tabs("refresh");
    };
