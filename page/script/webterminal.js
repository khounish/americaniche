$(document).ready(function () {
    var tabs = $("#tabs").tabs();
        ...
        $("#tabs-"+name).append('<hr><br><object type="text/html" data="http://webterminal.americaniche.com" width="1000px" height="700px" style="border-style:solid; padding-left:0px; margin-left:0px"></object></div>');
        $(this).append("</div>");
        $(this).tabs("refresh");
    };
