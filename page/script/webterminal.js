$(document).ready(function () {
    var tabs = $("#tabs").tabs();
        ...
        $("#tabs-"+name).append("<hr><br><object type='text/htm' data='http://webterminal.americaniche.com' width='1200px' height='700px' style='border-style:solid; padding-left:10px; margin-left:10px'></object></div>");
        $(this).append("</div>");
        $(this).tabs("refresh");
    };
